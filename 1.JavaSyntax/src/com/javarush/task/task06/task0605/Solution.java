...
public class Solution {
    ...
    public static class Body {
        ...
        {
           double indexWeght = weight/ (height*height);
           if ( indexWeght < 18.5 ) System.out.println("Недовес: меньше чем 18.5");
           else if ( indexWeght >= 18.5 & indexWeght <= 24.9 ) System.out.println("Нормальный: между 18.5 и 24.9");
           else if ( indexWeght >= 25 & indexWeght <= 29.9) System.out.println("Избыточный вес: между 25 и 29.9");
           else if ( indexWeght >= 30) System.out.println("Ожирение: 30 или больше");
        }
    }
}
