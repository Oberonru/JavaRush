...
/**
 * Родитель класса CTO
 * Добавь такой класс-родитель к классу CTO(технический директор), чтобы класс перестал
 * быть абстрактным.
...
public class Solution {
    ...
    public static class ParentSTO {
        public void workHard() {}
    }

    public static class CTO extends ParentSTO implements Businessman {
