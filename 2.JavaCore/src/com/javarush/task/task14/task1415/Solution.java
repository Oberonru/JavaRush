...
public class Solution {
    ...
    public static void cleanAllApartments(List<Apartment> apartments) {
        for (Apartment kubric : apartments) {
            if (kubric instanceof OneRoomApt) {
                ((OneRoomApt) kubric).clean1Room();
            }
            if (kubric instanceof TwoRoomApt) {
                ((TwoRoomApt) kubric).clean2Rooms();
            }
            if (kubric instanceof ThreeRoomApt) {
                ((ThreeRoomApt) kubric).clean3Rooms();
            }
        }
    }
