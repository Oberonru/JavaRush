 ...
 * 2. Метод speed должен возвращать значение типа Double и не должен ничего
 * принимать в качестве аргументов.
 ...
 * 5. В интерфейсе CanFly должен быть объявлен метод speed c одним аргументом
 * типа CanFly и с типом возвращаемого значения Double.
 * Всё, что движется
 */
